...
curve_fit_data = readmatrix("curve_fit_model_data_1.csv");
...
polynomial_coeffs = polyfit(x_x_distances, y_swing_angles, 15);
y_curve_fit_model = polyval(polynomial_coeffs, x_x_distances);
writematrix(polynomial_coeffs, "curve_fit_model_1.csv")
